...
## Simpson's Rule
In this exercise we will calculate the value of the following integral: $x(s) = x_o + \int_{0}^{s}cos(\Theta(s'))ds'$ NOTE: **x 0 will be 0 in this exercise.**
...
1. The definition of Theta(s) for a Cubic Spiral, which is: $\Theta(s) = \Theta_0 + \frac{a_3s^4}{4} + \frac{a_2s^3}{3} + \frac{a_1s^2}{2} + a_0s$

NOTE: **θ 0 will be 0 in this exercise.**
