...
**NOTE** - We are using the Waymo Open Dataset github repository to parse the raw tf record files. We would recommend to follow [this tutorial](https://github.com/waymo-research/waymo-open-dataset) 
