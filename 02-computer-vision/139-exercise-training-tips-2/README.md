...
## Before You Start Working in the Workspace

Before you start working in the workspace below, you must source the ***.student_bashrc*** file. The file has the following content:
```md
source /data/virtual_envs/sdc-c1-gpu-augment/bin/activate
PYTHONPATH=/data/virtual_envs/sdc-c1-gpu-augment/lib/python3.7/
site-packages:$PYTHONPATH
```
You can source the file as:
```bash
source .student_bashrc 
```
After sourcing the file, a new virtual Python environment will get activated for you.
