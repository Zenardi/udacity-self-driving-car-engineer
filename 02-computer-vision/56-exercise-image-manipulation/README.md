...
![Left - Original RGB Image, Center - The binary mask, Right - The masked RGB Image](images/example.jpeg)
*Left - Original RGB Image, Center - The binary mask, Right - The masked RGB Image*

![Pixel value distribution per channel](images/example2.jpeg)
