...
![*N* is set to 25 and *dt* is set to 0.05 for all other graphs in this section unless specified. The simulation is run for 60 iterations.](images/cte1.png)
...
![image](images/hard-steering.png)

![image](images/steering-angle-100.png)

![image](images/steering-angle-500.png)
