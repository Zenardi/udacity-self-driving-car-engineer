...
![The blue line is the reference trajectory and the red line the trajectory computed by *Model Predictive Control*. In this example the horizon has 7 steps, *N*, and the space in between white pebbles signifies the time elapsed, *dt*.](images/05-i-length-of-trajectory-and-timestep-duration-02.png)
...
. An optimizer will tune these inputs until a low cost vector of control inputs is found. The length of this vector is determined by *N*:
